          ...
          <div class="col-lg-7 col-md-6">
            <div class="about-content">
             <div class="form">
              ...
              <h4>Write Questions</h4>
              <form action="GiveQuestions" method="post">
                 <div class="form-group">
                  <textarea class="form-control" name="questions" rows="2" data-rule="required" data-msg="Please write your queries for us" placeholder="Please write your queries for us..."></textarea>
                  <div class="validation"></div>
                </div>
                <!-- <div class="form-group">
                  <textarea class="form-control" name="answers" rows="5" data-rule="required" data-msg="Please write your answers" placeholder="Please write your answers..."></textarea>
                  <div class="validation"></div>
                </div> -->
                <div class="text-center"><button type="submit" title="Send Message">Ask!</button></div>
              </form>
            </div>
          </div>
        </div>
