             ...
             <div class="form">
              ...
              <form action="Admin" method="post" >
                <div class="form-group">
                  <input type="email" class="form-control" name="uid" id="email" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" />
                  <div class="validation"></div>
                </div>
                <div class="form-group">
                  <input type="password" class="form-control" name="pwd" data-rule="required" data-msg="Please write something for us" placeholder="Password"></textarea>
                  <div class="validation"></div>
                </div>
